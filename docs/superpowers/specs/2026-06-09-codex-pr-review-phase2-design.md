...
- **mac:codex — implementatieplan round-3: GO ✅** (msg 08ef3429). Round-2-P1 correct verwerkt bevestigd (validation.ts in Files + steps, eigen `MANUAL_JOB_KINDS`, `ManualJobValidationInput.prUrl`, verplicht+formaat-regels, validatie-tests, save-draft-persistentie-test; File Structure + spec §4/§14 gesynct). **Geen resterende P1/P2/P3 — GO for implementation.**
