...
const claims = { issuer: 'scrum4me-workers' as const, userId: 'user-1', jti: 'action-1', now: 1000 }
const signed = () => signDispatchAssertion({ ...claims, ...request, key })
const verify = (assertion: string, change = {}) => verifyDispatchAssertion({ assertion, ...request, keys, now: 1000, ...change })
