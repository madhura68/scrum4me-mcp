...
export async function handleLogImplementation({
  story_id, content, metadata, task_id, execution_key, ppe,
  ...
  return withToolErrors(async () => {
    ...
    if (ppe) assertLogOperationKey(ppe, 'implementation', execution_key!)
    const request = {
    ...
    return executePpeMutation({
      ppe,
      operationKind: 'LOG_IMPLEMENTATION',
